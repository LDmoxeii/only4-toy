...
VALUES ('ui-1', '', '/ui-1', 1, '首页', 'Home', true, true),
       ('ui-2', '', '/ui-2', 2, '用户管理', 'User Management', true, true),
       ('ui-3', '', '/ui-3', 3, '系统设置', 'System Settings', true, true),
       ...
       ('ui-5', '', '/ui-5', 5, '消息通知', 'Notifications', true, true),
...
VALUES ('ui-1', '', '/ui-1', 1, '首页V2', 'Home V2', true, true),
       ('ui-2', '', '/ui-2', 2, '用户管理', 'User Management', false, true),
       ('ui-4', '', '/ui-4', 4, '数据分析', 'Data Analysis', true, true),
       ('ui-2-1', 'ui-2', '/ui-2/ui-2-1', 201, '用户列表', 'User List', true, true),
       ...
       ('ui-6', '', '/ui-6', 6, '日志管理', 'Log Management', true, true),
...
VALUES ('api-1', '', '/api-1', 1, '用户接口', 'User API', true, true),
       ('api-2', '', '/api-2', 2, '系统接口', 'System API', true, true),
       ...
       ('api-4', '', '/api-4', 4, '安全接口', 'Security API', true, true),
...
VALUES ('api-1', '', '/api-1', 1, '用户接口V2', 'User API V2', true, true),
       ('api-3', '', '/api-3', 3, '分析接口', 'Analytics API', true, true),
       ...
       ('api-5', '', '/api-5', 5, '监控接口', 'Monitoring API', true, true),
